...
| Drawing | Description |
|---|---|
| [Front baffle](assets/drawings/front_baffle.svg) | Midrange + waveguide cutouts, rebates, pilot holes, BCD patterns |
| [Side panel](assets/drawings/side_panel.svg) | Woofer cutout, 8 pilot holes on BCD, shelf brace positions |
| [Cut list](assets/drawings/cut_list.svg) | All 10 panels with dimensions, quantities, notes |
| [Assembly dims](assets/drawings/assembly_dims.svg) | Front + side elevation with driver heights, spacing, internal dims |

Per-panel cut drawings (one SVG per panel, ready for CNC/saw):

| Panel | File |
|---|---|
| Front baffle | [front_baffle.svg](assets/drawings/panel_front_baffle.svg) |
| Back panel | [panel_back.svg](assets/drawings/panel_back.svg) |
| Side panel L | [panel_side_left.svg](assets/drawings/panel_side_left.svg) |
| Side panel R | [panel_side_right.svg](assets/drawings/panel_side_right.svg) |
| Top panel | [panel_top.svg](assets/drawings/panel_top.svg) |
| Bottom panel | [panel_bottom.svg](assets/drawings/panel_bottom.svg) |
| Divider plate | [panel_divider.svg](assets/drawings/panel_divider.svg) |
| Shelf brace ×3 | [panel_shelf_brace.svg](assets/drawings/panel_shelf_brace.svg) |
