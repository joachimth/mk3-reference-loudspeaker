...
**Scripts:** [system_response_realistic.py](simulations/system_response_realistic.py) | [crossover_optimization.py](simulations/crossover_optimization.py)
...
**Scripts:** [directivity_estimate.py](simulations/directivity_estimate.py) | [vertical_polar_map.py](simulations/vertical_polar_map.py) | [vertical_lobing.py](simulations/vertical_lobing.py) | [polar_response.py](simulations/polar_response.py)
...
**Scripts:** [bass_alignment_maxspl.py](simulations/bass_alignment_maxspl.py) | [bass_volume_compare.py](simulations/bass_volume_compare.py)
