...
| Tweeter | **SB Acoustics SB26STAC-C000-4** in custom non-horn-loaded waveguide |
...
### Why the SB26STAC-C000-4

The SB26STAC is a conventional 26 mm soft dome tweeter with Fs 750 Hz — giving a
comfortable 350 Hz margin at the 1100 Hz crossover (no distortion-test gate
required). Its 0.6 mm Xmax gives +8.1 dB excursion headroom at the crossover,
and its 91.5 dB sensitivity is a natural match for the 15W midrange (only ~2 dB
of DSP pad needed). See `docs/SB26STAC-C000-4_analysis.md` for the full
selection analysis.
...
- [simulations/](simulations/) - Version-controlled simulation scripts + generated plots (bass alignment / max-SPL, vertical lobing, crossover optimization, tweeter selection analysis)
- [cad/](cad/) - Parametric CAD (OpenSCAD waveguide for the SB26STAC + cabinet)
- [dsp-configs/](dsp-configs/) - MiniDSP 4×10 HD XML configs + generator
- [assets/](assets/) - Datasheets (PDF + extracted CSV) and CAD render previews
